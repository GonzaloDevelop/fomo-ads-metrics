    ...
    return (
        <main style={{ fontFamily: 'sans-serif', maxWidth: 640, margin: '60px auto', padding: '0 24px', color: '#1a1a1a', lineHeight: 1.7 }}>
            ...
            <p style={{ marginBottom: 24 }}>
                Growth Brick es un dashboard de métricas para Meta Ads que permite a agencias y anunciantes visualizar el rendimiento de sus campañas publicitarias. Operado por Growth Brick · <a href="mailto:hola@growthbrick.tech" style={{ color: '#1877F2' }}>hola@growthbrick.tech</a>.
            </p>
